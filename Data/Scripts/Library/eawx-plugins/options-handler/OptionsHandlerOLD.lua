...
function OptionsHandler:on_construction_finished(planet, game_object_type_name)
	...
	elseif game_object_type_name == "OPTION_FS_UNITS" then 
        self:fs_units()
    elseif game_object_type_name == "OPTION_CANON_UNITS_ZSINJ" then
        self:canon_units_zsinj()
    end
...
function OptionsHandler:canon_units_zsinj()
    --Logger:trace("entering OptionsHandler:canon_units_zsinj")
